...
* [dog.h]: Header file containing definitions and prototypes for all types
...
* **0. Poppy**
  * [dog.h]: Header file that defines a new type `struct dog` with the
  following elements:
    * `char *name`
    * `float age`
    * `char *owner`
...
* **3. Outside of a dog, a book is a man's best friend. Inside of a dog it's too dark to read**
  * [dog.h]): Header file that defines a new type `dog_t` as a new name for the
  type `struct dog`.
